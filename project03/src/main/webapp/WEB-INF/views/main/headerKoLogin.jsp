...
<script>
	function fnValidate(){
		//<form> 태그의 name 속성으로 <form>태그의 객체를 받아온다.
			...
			login.action="/project03/listMember.do";
		}
...
<body>
	<header>
		<div id="header">
			<div id="logo">
				<h1>
					<a href="/project03/main/index.jsp" tabindex="1" title="농협은행 메인 로고"><img src="/project03/images/logo_new.jpg" class="showTooltip" title="농협은행 메인 로고" alt="logo images" width="180" height="35"/></a>
				</h1>
			</div>
			<div id="version">
				<ul>
						...
						<div class="twoDepthWrap">
							<div class="twoDepthTop cf">
								...
								<ul class="twoDepthList fl">
									...
									<li><a href="/project03/sub01/sub01Login.jsp" tabindex="183">자동송금변경서비스</a></li>
								</ul>
								<ul class="twoDepthList fl">
