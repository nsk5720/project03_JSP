		...
		<form method="POST">
			<div class="boardWrap">
				<div class="titlePart">
					...
					<div class="fl titleRight" colspan="2"><input type="text" name="title" value="${data.title}"/></div>
				</div>
				<div class="contentPart">
					<div class="fl contentLeft" valign="top">글내용:</div>
					<div class="fl contentRight" colspan="2"><textarea type="text" name="content" rows="10" cols="65" maxlength="4000">${data.content}</textarea> </div>
				</div>
				<div class="imagePart">
					<div class="fl imageLeft">작성자</div>
					<div class="fl fileSelect"colspan="2"><input type="text" name="writer" value="${data.writer}"/></div>
					<div class="fl imagePreview"></div>
				</div>
				<div class="fl" class="wirteButton">
					<input class="write" type="submit" value="수정하기"/>
					<!-- <input class="reset" type="button" value="목록보기" onClick="/project03/list"/> -->
				</div>
			</div>
		</form>
		</section>
